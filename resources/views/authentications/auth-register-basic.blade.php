      ...
      <div class="card p-2">
        ...
        <div class="app-brand justify-content-center mt-5">
          <a href="{{url('/')}}" class="app-brand-link gap-2">
            <span class="app-brand-logo demo"><img src="{{ asset('assets/img/favicon/logo.png') }}" alt="logo" style="height: 50px;"></span>
            <span class="app-brand-text demo text-heading fw-semibold">Hairaneeds</span>
          </a>
        </div>
        <!-- /Logo -->
